...
class SegHead(nn.Module):
    def __init__(self, in_channels=[96, 192, 384, 768], num_classes=1, in_index=[0, 1, 2, 3]):
...
class PyramidMiM(nn.Module):
    ...
    def __init__(self, configs=None, img_size=512, in_chans=3, num_classes=1, mlp_ratio=4., qkv_bias=False,
        ...
        #self.decode_head = SegHead(in_channels=[128,256,512,1024], num_classes=1, in_index=[0, 1, 2, 3])
